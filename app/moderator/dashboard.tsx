  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false} contentContainerStyle={styles.contentContainer}>
      <View style={styles.header}>
        <Text style={styles.headerTitle}>Painel do Moderador</Text>
      </View>

      <View style={styles.section}>
        <Text style={styles.sectionTitle}>Em desenvolvimento</Text>
        <Text style={styles.description}>
          O painel completo do moderador incluirá:
        </Text>
        <View style={styles.featureList}>
          {[
            ...
            <View key={index} style={styles.featureItem}>
              <Ionicons name="checkmark-circle" size={20} color="#FF9500" style={{ marginRight: 12 }} />
